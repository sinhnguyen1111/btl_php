...
<body class="align">
    ...
    $pass="";
        ...
        <form action="index.php?mod=auth&c=admin&act=checklogin" method="POST" class="form login">        
            ...
            <div class="form__field">
                ...
                <input id="login__password" type="password" name="password" class="form__input" placeholder="Password" value="<?php echo $pass?>" required>
            </div>
